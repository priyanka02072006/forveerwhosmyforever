export const WRAPPED_CARDS = [
  { kind: 'stat', label: 'Ragebaiter level', value: '97%', color: 'wrapped1' },
  { kind: 'stat', label: 'Leg-pulling frequency', value: 'Every. Single. Day.', color: 'wrapped2' },
  { kind: 'stat', label: 'Baby obsession level', value: 'Unmeasurable', color: 'wrapped3' },
  { kind: 'stat', label: 'Protective boyfriend score', value: '10/10', color: 'wrapped1' },
  ...
  { kind: 'most', label: 'Most likely to...', value: 'To screenshot something funny (especially me) and send it to me immediately.', color: 'wrapped2' },
  {
    ...
    value: 'The way you take care of things without making it a whole thing. You just do it.',
    color: 'wrapped1',
  },
]
